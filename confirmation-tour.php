    ...
    <body class="confirmation">
        ...
        <div class="wrapper clear">
        	<section>
                ...
                <p>We are delighted that you are interested in learning more about MUSE High School. We’ll be reaching out to you to answer any questions you may have. In the meantime, select a campus tour date now:</p>
        ...
        <div class="location-wrap clear">
            ...
            <h3>Our High School campus is nestled comfortably in the Santa Monica Mountains:</h3>
