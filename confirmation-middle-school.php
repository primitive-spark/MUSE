...
<html>
    ...
    <body class="confirmation middle">
    	<header class="clear">
        ...
        <div class="wrapper clear">
        	<section>
                ...
                <p>We are delighted that you are interested in learning more about MUSE Middle School. We’ll be reaching out to you to answer any questions you may have. In the meantime, select a campus tour date now:</p>
        ...
        <div class="location-wrap clear">
            ...
            <h3>Our Middle School campus is nestled comfortably in the Santa Monica Mountains:</h3>
            <img src="img/maps-mid.jpg" width="100%" class="hideMobile" alt="MUSE School"/>
            <div class="location">
