...
if($_POST['email']){
	...
	$content = "Someone has submitted a request for an Open House!<br /><br />";
	$content .= "Name: ".$fname. " ". $lname . "<br />";
	$content .= "Email: ".$email."<br />";
	if($phone){
		$content .= "Phone: ".$phone."<br />";
	}
	$content .= "Open House Time: ".$date."<br />";

	mail( $toEmail, 'Open House Form Submission', $content, $emailHeaders );
...
<html>
    <head>
        <title>MUSE - Open House Sign-up - Thank You</title>
    ...
    <body class="confirmation">
        ...
        <div class="wrapper clear">
        	<section>
            	<h1>See you at the Open House!</h1>
                <p>We are thrilled you have decided to see MUSE High School for yourself. Look out for a confirmation email with further instructions. In the meantime, feel free to <a href="http://museschool.org/contact-us/" title="Contact Us">contact us</a> with any questions or to learn more about MUSE School's <a href="http://museschool.org/admissions/process/" title="Admissions Process">admissions process</a>.</p>
